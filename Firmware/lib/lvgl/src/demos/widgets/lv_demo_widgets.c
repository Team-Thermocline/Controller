...
void lv_demo_widgets(void)
{
    ...
    ui_widgets = lv_obj_create(NULL);
    tv = lv_tabview_create(ui_widgets, LV_DIR_TOP, tab_h);

    lv_obj_set_style_text_font(ui_widgets, font_normal, 0);
...
static void profile_create(lv_obj_t * parent)
{
    ...
    /*Create a keyboard*/
    lv_obj_t * kb = lv_keyboard_create(ui_widgets);
